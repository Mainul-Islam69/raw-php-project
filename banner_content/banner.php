...
<div class="container-fluid">
    ...
    <div class="card">
      <div class="card-header bg-success">
        <h3 class="text-white">Banner Contents List</h3>
      </div> 
      <div class="card-body">
        <table class="table table-striped">
            ...
            <?php foreach($select_banner as $key=>$banner){?>
             <tr>
                ...
                <td><?=$banner['title']?></td>
                <td><?=$banner['desp']?></td>
                <td><a href="banner_status.php?id=<?=$banner['id']?>"><span class="badge bg-<?=($banner['status'] ==1? 'primary' : 'success')?>"><?=($banner['status'] ==1? 'Active' : 'Deactive')?></span></a></td>
                <td>
                <div class="dropdown">
    ...
    <div class="card-body">
        ...
        <div class="mb-3">
        <button type="submit" class="btn text-white bg-info form-control">Add Banner</button>
        </div>
        </form>
    </div>
    </div>
