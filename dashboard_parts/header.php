...
if(empty ($after_assoc_user)){
     header('location:/Project1/logout.php');
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<link rel="stylesheet" href="/Project1/dashboard_asset/vendor/chartist/css/chartist.min.css">
    <link href="/Project1/dashboard_asset/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="/Project1/dashboard_asset/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="/Project1/dashboard_asset/images/logo.png" alt="">
                <img class="logo-compact" src="/Project1/dashboard_asset/images/logo-text.png" alt="">
                <img class="brand-title" src="/Project1/dashboard_asset/images/logo-text.png" alt="">
            </a>
            ...
            <div class="header-content">
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
						...
						<a target="blank" href="/Project1/" class="btn btn-danger">Live Project</a>
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
								...
								<img src="/Project1/uploads/user/<?=$after_assoc_user['image']?>" width="20" alt=""/>
				...
				<a href="/Project1/users/profile.php" class="dropdown-item ai-icon">
					<svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
					<span class="ml-2">Profile </span>
				</a>
			
				<a href="/Project1/logout.php" class="dropdown-item ai-icon">
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
                ...
                <li>
					<a class="has-arrow ai-icon" href="/Project1/dashboard.php" aria-expanded="false">
                ...
                <li>
					<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <li><a href="/Project1/users/users.php">User List</a></li>
                  </ul>
                 ...
                 <li>
					<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                        <li><a href="/Project1/logo/logo.php">Add Logo</a></li>
                  </ul>
				</li>
                 ...
                 <li>
					<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                        <li><a href="/Project1/banner_content/banner.php">Add Banner</a></li>
                        <li><a href="/Project1/banner_content/banner_image.php">Add Banner Image</a></li>
                  </ul>
				</li>
                 ...
                 <li>
					<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                        <li><a href="/Project1/social/social.php">Add Social Icon</a></li>
                ...
                <!-- ab-->
                 <li>
					<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                        <li><a href="/Project1/about_content/about.php">Add About Contents</a></li>
                        <li><a href="/Project1/about_content/about_section_image.php">Add About Section Image</a></li>
                  </ul>
				</li>
				...
				<li>
					<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                        <li><a href="/Project1/education/education.php">Add Education</a></li>
				...
				<li>
					<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                        <li><a href="/Project1/services/service.php">Add Service</a></li>  
                  </ul>
				</li>
				...
				<li>
					<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                        <li><a href="/Project1/works/work.php">Add Work</a></li>  
                  </ul>
				</li>
				...
				<li>
					<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                        <li><a href="/Project1/facts/fact.php">Add Fact</a></li>
				...
				<li>
					<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                        <li><a href="/Project1/review/review.php">Add Review</a></li>
				...
				<li>
					<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                        <li><a href="/Project1/brand/brand.php">Add Brand</a></li>
                  </ul>
				</li>
				...
				<li>
					<a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                        <li><a href="/Project1/contact/contact.php">Add Contact</a></li>
                        
                  </ul>
				</li>

				<li>
					<a class="has-arrow ai-icon" href="/Project1/message/messages.php" aria-expanded="false">
						<i class="flaticon-381-television"></i>
