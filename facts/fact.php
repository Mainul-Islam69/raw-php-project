<?php 
    ...
    $select_facts = mysqli_query($db_connection, $select);
?>
<div class="container">
    <div class="row">
        <div class="col-lg-12 m-auto">
            <div class="card">
                <div class="card-header bg-primary">
                    <h3 class="text-white">Fact Icon List</h3>
                </div>
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <?php foreach($select_facts as $key=>$fact){?>
                            <tr>
                                <td><?=$key+1?></td>
                                <td><i style="font-family: fontawesome;" class="<?=$fact['icon']?>"></i></td>
                                <td><?=$fact['number']?></td>
                                <td><?=$fact['title']?></td>
                                <td><a href="fact_status.php?id=<?=$fact['id']?>"><span class="badge bg-<?=($fact['status'] ==1? 'primary' : 'success')?>"><?=($fact['status'] ==1? 'Active' : 'Deactive')?></span></a></td>
                                <td>
         ...
         <?php 
                ...
                ?>
                 <?php foreach($fonts as $icon){ ?>
                                <i data-icon="<?=$icon?>" style="font-family: fontawesome;font-size:20px;margin-right:2px;font-style:none" class="<?=$icon?> icon_class"></i>
                            <?php } ?> 
         </div>
        <div class="col-lg-10 m-auto">
            <div class="card">
                <div class="card-header bg-success">
                    <h3 class="text-white">Add Fact Detalis</h3>
                </div>
                ...
                <div class="card-body">
                    <form action="fact_post.php" method="POST">
                        ...
                        <div class="mb-3">
                            <input type="number" name="number" class="form-control" placeholder="Count Number">
                        </div>
