            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tr>
                            <td><?=$key+1?></td>
                            <td><img width="100" src="/Project1/uploads/logo/<?=$logo['logo']?>" alt=""></td>
                           <td><a href="logo_status.php?id=<?=$logo['id']?>"><span class="badge bg-<?=($logo['status'] ==1? 'primary' : 'success')?>"><?=($logo['status'] ==1? 'Active' : 'Deactive')?></span></a></td>
                            <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="delete_logo.php?id=<?=$logo['id']?>">Delete</a>
                                </div>
                            </div>
                            </td>
                        </tr>
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-header bg-success">
                    <h3 class="text-white">Add Logo</h3>
                </div>
                <div class="card-body">
