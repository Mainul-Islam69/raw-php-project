                ...
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <?php foreach($select_service as $key=>$service){?>
                            <tr>
                                <td><?=$key+1?></td>
                                <td><i style="font-family: fontawesome;" class="<?=$service['icon']?>"></i></td>
                                <td><?=$service['sub_title']?></td>
                                <td><?=$service['title']?></td>
                                <td><a href="service_status.php?id=<?=$service['id']?>"><span class="badge bg-<?=($service['status'] ==1? 'primary' : 'success')?>"><?=($service['status'] ==1? 'Active' : 'Deactive')?></span></a></td>
                                <td>
            ...
            <div class="mb-3">
                ...
                ?>
                 <?php foreach($fonts as $icon){ ?>
                                <i data-icon="<?=$icon?>" style="font-family: fontawesome;font-size:30px;margin-right:3px;font-style:none" class="<?=$icon?> icon_class"></i>
                            <?php } ?> 
         </div>
        ...
        <div class="col-lg-10 m-auto">
            <div class="card">
                <div class="card-header bg-success">
                    <h3 class="text-white">Add Services</h3>
                </div>
