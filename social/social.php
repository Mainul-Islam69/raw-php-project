                ...
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="icon_status.php?id=<?=$icon['id']?>"><span class="badge bg-<?=($icon['status'] ==1? 'primary' : 'success')?>"><?=($icon['status'] ==1? 'Active' : 'Deactive')?></span></a>
                            </td>
                            <td>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div style="background-color: BlueViolet ;" class="card-header">
                    <h3 class="text-white">Add Icon</h3>
                </div>
                <?php 
                    $fonts = array (
                        'fa-apple',
