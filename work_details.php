...
$after_asso = mysqli_fetch_assoc($select_res);
...
$select_res = mysqli_query($db_connection, $select);
$after_assoc_user = mysqli_fetch_assoc($select_res);
?>
<!doctype html>
                        ...
                        <div class="col-xl-12">
                            <div class="main-menu">
                                <nav class="navbar navbar-expand-lg">
                                    <a href="index.html" class="navbar-brand logo-sticky-none"><img src="uploads/logo/<?=$after_assoc_logo['logo']?>" alt="Logo"></a>
                                    <a href="index.html" class="navbar-brand s-logo-none"><img src="uploads/logo/<?=$after_assoc_logo['logo']?>" alt="Logo"></a>
            ...
            <div class="extra-info">
                ...
                <div class="side-info mb-30">
                    <div class="contact-list mb-30">
                        ...
                        <p><?=$after_asso['address']?></p>
                    </div>
                    <div class="contact-list mb-30">
                        <h4>Phone Number</h4>
                        <p><?=$after_asso['phone']?></p>
                    </div>
                    <div class="contact-list mb-30">
                        <h4>Email Address</h4>
                        <p><?=$after_asso['email']?></p>
                    </div>
                </div>
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img height="700" src="uploads/works/<?=$after_assoc['image']?>" alt="img">
                                </div>
                                    ...
                                    <div class="blog-list-meta">
                                        <ul>
                                            ...
                                            <li class="blog-post-share">
                                                <a target="_blank" href="https://www.facebook.com/sharer.php?u=http://127.0.0.1/Brim/work_details.php?id=<?=$after_assoc['id']?>"><i class="fab fa-facebook-f"></i></a>
                                                <a target="_blank"  href="http://www.twitter.com/share?url=http://127.0.0.1/Brim/work_details.php?id=<?=$after_assoc['id']?>"><i class="fab fa-twitter"></i></a>
                                                <a target="_blank"  href="http://www.instagram.com/share?url=http://127.0.0.1/Brim/work_details.php?id=<?=$after_assoc['id']?>"><i class="fab fa-instagram"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
