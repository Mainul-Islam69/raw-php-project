...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12 m-auto">
            <div class="card">
                <div style="background-color: navy;" class="card-header">
                    <h3 class="text-white">Works List</h3>
                </div>
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td><img width="60" src="../uploads/works/<?=$work['image']?>" alt=""></td>
                            <td>
                                <div class="dropdown">
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header bg-success">
                    <h3 class="text-white">Add Works</h3>
                </div>
                <div class="card-body">
